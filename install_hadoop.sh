...
ansible-playbook  --private-key=~/.ssh/kepri-msa.pem ./vars/add_hosts.yml

ansible-playbook  --private-key=~/.ssh/kepri-msa.pem ./vars/add_known_hosts.yml

ansible-playbook  --private-key=~/.ssh/kepri-msa.pem ./vars/add_authorized_keys.yml
